    ...
    <>
        ...
        <div className='book-list'>
            ...
            {devs.map((dev, index) => (
                    ...
                    coverImageUrl={dev.coverImageUrl}
                    publisher={dev.publisher}
                    publicationDate={dev.publicationDate}
                    detailedDescription={dev.detailedDescription}
                    key={index}
                    />
                ))}
            </div>
...
const Books = ({ title, author, url, shortDescription, coverImageUrl, publisher, publicationDate, detailedDescription }) => {
    ...
    const imgNotFound = 'https://islandpress.org/sites/default/files/default_book_cover_2015.jpg'
        ...
        return (
            <div>
                ...
                <p style={{ padding: '10px, 0px, 10px, 0px'}}>{shortDescription}</p>
